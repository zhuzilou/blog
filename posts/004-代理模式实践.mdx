...
const proxyImage = (function () {
  ...
  return {
    setSrc: function (src) {
      myImage.setSrc(`http://s5nvjgtjr.hd-bkt.clouddn.com/202401082205206.png`)
...
// 添加时间戳避免被缓存
const targetImage = 'http://s5nvjgtjr.hd-bkt.clouddn.com/202401082156214.png?time=' + Date.now()
...
![](http://s5nvjgtjr.hd-bkt.clouddn.com/202401082259543.png)
